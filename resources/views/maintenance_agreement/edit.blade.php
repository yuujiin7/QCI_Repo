...
<div class="px-2 w-1/4">
    ...
    @enderror
                ...
                <input type="file" id="sr_image" name="sr_image" class="bg-gray-200 rounded w-full text-gray-800 px-3 py-2 focus:outline-none focus:bg-white border-2 border-gray-300" onchange="previewImage(event)">
                        ...
                        <!-- <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:placeholder-gray-400" aria-describedby="sr_image_help" id="sr_image" type="file" value={{$service_report->sr_image}} > -->
