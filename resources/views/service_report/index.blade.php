                        ...
                        <tr class="bg-white border-b text-black hover:bg-gray-50">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <a href="/service-report/{{ $sr->id }}" class="bg-blue-600 text-white px-4 py-1 rounded hover:bg-blue-700" ><svg class="w-6 h-6 text-white-800s" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
