                        ...
                        <tr class="bg-white border-b text-black hover:bg-gray-50">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="/service-report/{{ $sr->id }}" method="POST" class="inline" id="deleteFormSR">
                                        @csrf
                                        @method('DELETE')
                                        <button class="bg-red-600 text-white px-4 py-1 rounded hover:bg-red-700 submitDelete" data-form-id="deleteFormSR"> 
                                            <svg class="w-6 h-6 text-white-800 dark:text-gray" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
