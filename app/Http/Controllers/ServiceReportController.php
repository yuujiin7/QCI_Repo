...
class ServiceReportController extends Controller
{
    ...
    public function index()
    {
        $serviceReports = ServiceReport::all();

        return view('service_report.index', ['service_report' => $serviceReports]);
    }

    public function show($id)
    {
        $serviceReport = ServiceReport::with('srImages')->findOrFail($id);
        
        return view('service_report.show', ['service_report' => $serviceReport]);
    }
